...
('Braintree', 		'{ts escape="sql"}Braintree{/ts}', '{ts escape="sql"}Braintree{/ts}', 1, 0, 'Merchant Id', 'Public Key', 'Private Key', NULL, 'Payment_Braintree', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL);
